...
namespace Commons
{
    public abstract class ObjectPool: MonoBehaviour {
        public static Transform InstancePool;
    }

    public abstract class ObjectPool<T> : ObjectPool where T : ObjectPool<T>
    {
        ...
        public static void Enqueue(int poolSize, T Prefabs)
        {
            ...
            {
                T gameObject = Instantiate(Prefabs, InstancePool);
        ...
        public void Destroy()
        {
            ...
            transform.SetParent(InstancePool, false);
